...
static struct snddev_icodec_data snddev_fluid_iearpiece_rx_data = {
	...
	.pamp_on = &msm_snddev_poweramp_on_speaker,
	.pamp_off = &msm_snddev_poweramp_off_speaker,
	.max_voice_rx_vol[VOC_NB_INDEX] = 1400,
	.min_voice_rx_vol[VOC_NB_INDEX] = -100,
...
static struct adie_codec_hwsetting_entry speaker_tx_settings[] = {
#if 0
	{
		.freq_plan = 8000,
		.osr = 256,
		.actions = speaker_tx_8KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(speaker_tx_8KHz_osr256_actions),
	},
	{ /* 8KHz profile is good for 16KHz */
		.freq_plan = 16000,
		.osr = 256,
...
static struct adie_codec_hwsetting_entry headset_tx_settings[] = {
#if 0
	{
		.freq_plan = 8000,
		.osr = 256,
		.actions = headset_tx_8KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(headset_tx_8KHz_osr256_actions),
	},
	{
		.freq_plan = 16000,
		.osr = 256,
		.actions = headset_tx_16KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(headset_tx_16KHz_osr256_actions),
	},
#endif
	{
		.freq_plan = 48000,
